...
namespace BadCode
{
    public class Controller
    {
        ...
        public void Init()
        {
            ...
            tournament = tournamentRepository.GetT(tournamentName);
        ...
        public void ShowScore(string tournamentName)
        {
            ...
            Tournament selectedTournament = tournamentRepository.GetT(tournamentName);
        ...
        {
            Tournament tournament = tournamentRepository.GetT(tournamentName);
        ...
        {
            return tournamentRepository.GetT(name);
        }
    }
}
